...
package body tests_TAD_Ensemble is
   ...
   -- cas NÂ°1 : un seul element dans l'ensemble
   ...
   -- test retirerChiffre sur ensemble vide
   -- cas nÂ°2 : plusieurs elements dans l'ensemble
   ...
   --Test du plus petit élément avec plusieurs posibilités(sous programme ajouté)
